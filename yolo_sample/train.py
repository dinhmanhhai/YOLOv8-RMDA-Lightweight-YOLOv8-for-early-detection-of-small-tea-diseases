...
from custom_backbone import register_yolo_modules
...
def main():
    ...
    """
    # Đăng ký Conv tùy chỉnh trước khi tạo model từ YAML
    register_yolo_modules()

    # Load model YOLO với kiến trúc sử dụng ConvRFC trong backbone
