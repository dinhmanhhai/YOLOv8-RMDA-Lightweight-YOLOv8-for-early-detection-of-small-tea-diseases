# Extra block modules for Improved YOLOv8s
...
from ..modules.conv import Conv, RepConv
from ..modules.block import Bottleneck, C2f, C3
...
class AKConv(nn.Module):
    ...
    def _get_p_n(self, N, dtype):
        """Generate the initial sampled shapes for the AKConv with different sizes."""
...
class Bottleneck_AKConv(Bottleneck):
    """Standard bottleneck with AKConv."""
...
class RepGFPN(nn.Module):
    """
    Re-parameterized Generalized Feature Pyramid Network.
    Uses RepConv for efficient feature fusion across scales.
    """
